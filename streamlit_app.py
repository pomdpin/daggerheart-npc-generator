...
if st.button("Générer / Generate"):
    ...
    prenoms = namemaker.make_name_set(names["Prénoms"], order=1, name_len_func=len, clean_up=True, exclude_real_names = True, exclude_history = True, add_to_history = True , n_candidates = 5)
